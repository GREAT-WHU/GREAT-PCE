...
const int t_gnavbds::_getIODC() const
{
	...
	BDSADDBITSFLOAT(14, _idot,   G_PI / static_cast<double>(1 << 30) / static_cast<double>(1 << 13))
	BDSADDBITSFLOAT(11, _f2,      1.0 / static_cast<double>(1 << 30) / static_cast<double>(1 << 30)
	...
	BDSADDBITSFLOAT(16, _dn,     G_PI / static_cast<double>(1 << 30) / static_cast<double>(1 << 13))
	BDSADDBITSFLOAT(32, _m,      G_PI / static_cast<double>(1 << 30) / static_cast<double>(1 <<  1))
	...
	BDSADDBITSFLOAT(32, _OMG,    G_PI / static_cast<double>(1 << 30) / static_cast<double>(1 <<  1))
	BDSADDBITSFLOAT(18, _cis,     1.0 / static_cast<double>(1 << 30) / static_cast<double>(1 <<  1))
	BDSADDBITSFLOAT(32, _i,      G_PI / static_cast<double>(1 << 30) / static_cast<double>(1 <<  1))
	BDSADDBITSFLOAT(18, _crc,     1.0                                / static_cast<double>(1 <<  6))
	BDSADDBITSFLOAT(32, _omega,  G_PI / static_cast<double>(1 << 30) / static_cast<double>(1 <<  1))
	BDSADDBITSFLOAT(24, _OMGDOT, G_PI / static_cast<double>(1 << 30) / static_cast<double>(1 << 13))
	BDSADDBITS(5, 0)
...
int t_gnavbds::data2nav( string sat, const t_gtime& ep, const t_gnavdata& data )
{
  ...
  if (data_21 == 0 || data_21 != _toc.gwk() - CONV_BWK2GWK && data_21 != _toc.gwk()) { //RT BDS broadcast ==0
