...
//          if( _sat == "E14") cerr << setw(9) << gnavtype2str(_gnavtype(true)) << " INAV E01-B + E4b-I healthy \n"; 
//    else{ if( _sat == "E14") cerr << setw(9) << gnavtype2str(_gnavtype(true)) << " INAV E01-B + E4b-I unhealthy \n"; return false; }
  }
...
//          if( _sat == "E14") cerr << setw(9) << gnavtype2str(_gnavtype(true)) << " INAV E01-B healthy \n"; return true; } // HS && DVS
//    else{ if( _sat == "E14") cerr << setw(9) << gnavtype2str(_gnavtype(true)) << " INAV E01-B unhealthy \n";  return false; }
  }
...
//          if( _sat == "E14") cerr << setw(9) << gnavtype2str(_gnavtype(true)) << " INAV E5a-I healthy \n"; return true; } // HS && DVS
//    else{ if( _sat == "E14") cerr << setw(9) << gnavtype2str(_gnavtype(true)) << " INAV E5a-I unhealthy \n";  return false; }
  }
...
//          if( _sat == "E14") cerr << setw(9) << gnavtype2str(_gnavtype(true)) << " INAV E5b-I healthy \n"; return true; } // HS && DVS
//    else{ if( _sat == "E14") cerr << setw(9) << gnavtype2str(_gnavtype(true)) << " INAV E5b-I unhealthy \n";  return false; }
  }
