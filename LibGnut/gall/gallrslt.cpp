...
void t_gallrslt::append(const t_gallrslt::result &rslt)
{
    ...
    else if(rslt.type == "TRP") {set_trp.insert(rslt);}
    else if(rslt.type == "CLK") {set_clk.insert(rslt);}
    else if(rslt.type == "AMB") {set_amb.insert(rslt);}
    else
    {
...
// append values
// ----------
void t_gallrslt::append(string type, t_gtime beg, t_gtime end, int idx,
                        string prn, double adj, double rms, double val)
{
    ...
    else if(type == "TRP") {set_trp.insert(rslt);}
    else if(type == "CLK") {set_clk.insert(rslt);}
    else if(type == "AMB") {set_amb.insert(rslt);}
    else
    {
        cerr<< "WRONG TYPE. POSSSIBLE ARE: CRD_X, CRD_Y, CRD_Z, CLK, TRP, AMB" <<endl;
    }
