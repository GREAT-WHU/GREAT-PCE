...
void LibGnut_LIBRARY_EXPORT QRZT(Matrix&, LowerTriangularMatrix&);

void LibGnut_LIBRARY_EXPORT QRZT(const Matrix&, Matrix&, Matrix&);

void LibGnut_LIBRARY_EXPORT QRZ(Matrix&, UpperTriangularMatrix&);

void LibGnut_LIBRARY_EXPORT QRZ(const Matrix&, Matrix&, Matrix&);
...
//MAT_LIBRARY_EXPORT ReturnMatrix Cholesky(const SymmetricMatrix&);
//
//MAT_LIBRARY_EXPORT ReturnMatrix Cholesky(const SymmetricBandMatrix&);

ReturnMatrix LibGnut_LIBRARY_EXPORT Cholesky(const SymmetricMatrix& S);

ReturnMatrix LibGnut_LIBRARY_EXPORT Cholesky(const SymmetricBandMatrix& S);
...
int LibGnut_LIBRARY_EXPORT SVD(const Matrix&, DiagonalMatrix&, Matrix&, Matrix&,
    bool=true, bool=true);

void LibGnut_LIBRARY_EXPORT SVD(const Matrix&, DiagonalMatrix&);
